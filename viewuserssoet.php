...
<label class="control-label col-sm-2" for="user" style="margin-left:30%;margin-top:30px;">SELECT USER:</label>
    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="margin-top:30px;">SOET
    <span class="caret"></span></button>
    <ul class="dropdown-menu" style="margin-left:45%;">
     <li><a href="viewuserssoet.php">SOET</a></li>
      <li><a href="viewusersspa.php">SPA</a></li>
      <li><a href="viewuserssom.php">SOM</a></li>
      <li><a href="viewuserscll.php">CLL</a></li>
      <li><a href="viewuserssol.php">SOL</a></li>   
</ul>
  </div>
