    ...
    <body>
        ...
        <div class="maindiv">  
            ...
            <div class="rightmenu" style="width: 500px; margin-left: 200px;">
                ...
                <form class="form-horizontal" action="update.php" onsubmit="return check()" method="POST">
                    <div>
                        
                        <fieldset class="form-group">
                            <legend ><b>FETCH SECTION</b></legend>
                        
                         
                      <div class="form-group" style="height:25px;">
                               
                     <div class="form-group" style="height:25px;">
                      <label class="control-label col-sm-5" for="phone">Contact Number:<span style="color:red;">*</span></label>
                      <div class="col-sm-5">
...
<br>
		<div class="form-group" style="height:25px;">
                      <label class="control-label col-sm-5" for="type">User Type:<span style="color:red;">*</span></label>
                      <div class="col-sm-5">
